...
INSERT INTO CatalogItemImages (catalog_item_id, fog_type_id, container_image)
VALUES 
    (@router_id, 1, 'ghcr.io/datasance/router:3.2.0'),
    (@router_id, 2, 'ghcr.io/datasance/router:3.2.0'),
    (@proxy_id, 1, 'ghcr.io/datasance/proxy:3.0.2'),
    (@proxy_id, 2, 'ghcr.io/datasance/proxy:3.0.2');
